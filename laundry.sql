...
--
-- Host: my_db
-- Waktu pembuatan: 08 Jul 2024 pada 15.00
...
INSERT INTO `calendar` (`bulan`) VALUES
(1),
(2),
(3),
(4),
...
(1, 2, 'my first customer', 'Solo', 'Perempuan', '085875838356');
...
INSERT INTO `pengaturan` (`id`, `nama_usaha`, `alamat`, `email`, `no_telepon`, `pesan`) VALUES
(1, 'Teratai Laundry', 'Solo, Jawa Tengah', 'teratailaundry@gmail.com', '082312321', 'Halo [nama_cs],\r\n\r\nKami ingin memberitahukan bahwa orderan laundry Anda dengan nomor pesanan [no_transaksi] telah selesai dan siap untuk diambil. Berikut adalah detail pesanannya:\r\n\r\n[item]\r\nTotal Orderan : [total]\r\n\r\nAnda dapat mengambilnya kapan saja di [nama_usaha]. Jika Anda memiliki pertanyaan atau perlu bantuan lebih lanjut, jangan ragu untuk menghubungi kami.\r\n\r\nTerima kasih telah menggunakan layanan kami!\r\n\r\nSalam,\r\n[nama_owner]\r\n[nama_usaha]');
...
(1, 'owner', '202cb962ac59075b964b07152d234b70', 1, 1),
(2, 'customer', '202cb962ac59075b964b07152d234b70', 2, 1);
